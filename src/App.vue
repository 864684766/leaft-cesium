...
const Cesium3D = defineAsyncComponent(() => 
...
<template>
  <div class="container mx-auto p-4">
    <div class="flex space-x-4 mb-4">
      <button
        ...
        :class="[`px-4 py-2 rounded font-bold`, 
                 mapMode === '2D' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700']"
      ...
      <button
        ...
        :class="[`px-4 py-2 rounded font-bold`,
                 mapMode === '3D' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700']"
        :disabled="isTransitioning"
      >
        三维地图
      </button>
    ...
    <div class="relative">
      ...
      <div v-show="cesiumVisible" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
        <Cesium3D 
          ref="cesiumRef"
          :centerPoint="centerPoint" 
        />
